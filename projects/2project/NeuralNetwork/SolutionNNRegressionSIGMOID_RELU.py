...
title_NN = 'NN_prediction_sigmoid_relu'
...
plt.savefig('../Figures/NN/train_heatmap_using_sigmoid_relu.pdf')
...
ax.set_ylabel("$\eta$")
ax.set_xlabel("$\lambda$")
plt.savefig('../Figures/NN/test_heatmap_using_sigmoid_relu.pdf')
