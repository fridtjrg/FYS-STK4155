...
title_NN = 'NN_prediction_sigmoid_tanh'
...
plt.savefig('../Figures/NN/train_heatmap_using_sigmoid_tanh.pdf')
...
ax.set_ylabel("$\eta$")
ax.set_xlabel("$\lambda$")
plt.savefig('../Figures/NN/test_heatmap_using_sigmoid_tanh.pdf')
